...
*/
DECLSPEC char* SDLCALL SDL_GetErrorMsg(char *errstr, unsigned int maxlen) {
	SDL_error *error;
...
#pragma message (__FILE__ "[" STRING(__LINE__) "]: " STRING(DECLSPEC) " char* " STRING(SDLCALL) " " __FUNCTION__ " ();" )
