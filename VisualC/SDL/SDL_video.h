 ...
 * surface.
 */
DECLSPEC SDL_Surface * SDLCALL SDL_GetVideoSurface(void);
 ...
 * are not available.
 */
DECLSPEC SDL_Surface * SDLCALL SDL_SetVideoMode
 ...
 */
DECLSPEC void SDLCALL SDL_UpdateRects
 ...
 */
DECLSPEC int SDLCALL SDL_Flip(SDL_Surface *screen);
 ...
 */
DECLSPEC int SDLCALL SDL_SetPalette(SDL_Surface *surface, int flags,
 ...
 */
DECLSPEC Uint32 SDLCALL SDL_MapRGB
 ...
 */
DECLSPEC Uint32 SDLCALL SDL_MapRGBA
(const SDL_PixelFormat * const format,
 ...
 */
DECLSPEC SDL_Surface * SDLCALL SDL_CreateRGBSurface
 ...
 */
DECLSPEC int SDLCALL SDL_SaveBMP_RW
 ...
 */
DECLSPEC int SDLCALL SDL_SetColorKey
 ...
 */
DECLSPEC int SDLCALL SDL_SetAlpha(SDL_Surface *surface, Uint32 flag, Uint8 alpha);
 ...
 */
DECLSPEC SDL_Surface * SDLCALL SDL_ConvertSurface
 ...
 */
DECLSPEC int SDLCALL SDL_UpperBlit
			(SDL_Surface *src, SDL_Rect *srcrect,
			 SDL_Surface *dst, SDL_Rect *dstrect);
/** This is a semi-private blit function and it performs low-level surface
 *  blitting only.
 */
DECLSPEC int SDLCALL SDL_LowerBlit
			(SDL_Surface *src, SDL_Rect *srcrect,
			 SDL_Surface *dst, SDL_Rect *dstrect);
 ...
 */
DECLSPEC int SDLCALL SDL_FillRect
 ...
 */
DECLSPEC SDL_Surface * SDLCALL SDL_DisplayFormat(SDL_Surface *surface);
 ...
 */
DECLSPEC SDL_Overlay * SDLCALL SDL_CreateYUVOverlay(int width, int height,
				Uint32 format, SDL_Surface *display);

/** Lock an overlay for direct access, and unlock it when you are done */
DECLSPEC int SDLCALL SDL_LockYUVOverlay(SDL_Overlay *overlay);
DECLSPEC void SDLCALL SDL_UnlockYUVOverlay(SDL_Overlay *overlay);
 ...
 */
DECLSPEC int SDLCALL SDL_DisplayYUVOverlay(SDL_Overlay *overlay, SDL_Rect *dstrect);

/** Free a video overlay */
DECLSPEC void SDLCALL SDL_FreeYUVOverlay(SDL_Overlay *overlay);
 ...
 */
DECLSPEC int SDLCALL SDL_WM_ToggleFullScreen(SDL_Surface *surface);
 ...
 */
DECLSPEC SDL_GrabMode SDLCALL SDL_WM_GrabInput(SDL_GrabMode mode);

/*@}*/

/** @internal Not in public API at the moment - do not use! */
DECLSPEC int SDLCALL SDL_SoftStretch(SDL_Surface *src, SDL_Rect *srcrect,
                                    SDL_Surface *dst, SDL_Rect *dstrect);
